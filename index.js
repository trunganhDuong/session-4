...
//     console.log(x);
// }
// // the for-in loop let you loop through properties of an object/ index of an array
...
// // 3.1
// console.log("Data type of the outermost layer is: " + typeof(jobSearch));
// //3.2
// console.log("Property 'hits' is an array" );
// // 3.3
// const {hits} = jobSearch;
// for(let i =0;i<hits.length; i++){
//     console.log("Job Title: ", hits[i].jobTitle);
//     console.log("Locations: ", hits[i].locations);
//     console.log("Salary: ", hits[i].jobSalary);
//     console.log("Benefits: ", hits[i].benefits);
//     console.log("Skills: ", hits[i].skills);
//     console.log("Skills: ", hits[i].jobRequirement);
//     console.log("--------------------");

//     // using object destructing
//     // let {jobTitle, locations, jobSalary, benefits, skills, jobRequirement}= hits[i];
// }

// // using for-of loop(You can search: FOR-IN LOOP JAVASCRIPT for further information)
// for (let hit of hits) {
//     let { jobTitle, locations, jobSalary, benefits, skills, jobRequirement } = hit;
// }
...
//     }
//     else {
//         const explaination = prompt(word + " is not found in the dictionary. Enter your explaination");
//         while (explaination == '') {
//             alert("Explaination must not be empty");
//             explaination = prompt(word + " is not found in the dictionary. Enter your explaination");
//         }

//         dict[word] = explaination;
//         alert("Done");
//     }
...
//     console.log("#" + (Number(index) + 1) + " Name: " + name);
//     console.log("   Price: " + price);
// }
...
//     position = prompt("Enter product position");
//     position = Number(position);
// }
// console.log("PRODUCT No." + position);
// const { name, brand, price, color, category } = products[position - 1];
// console.log("Name: " + name);
...
// 5.3
// const cate = prompt("Enter category");
// while (cate == '') {
//     alert("Input must not be empty");
//     cate = prompt("Enter category");
// }
// for (let product of products) {
//     if (product.category.toLowerCase() == cate.toLowerCase()) {
//         console.log("------------------");
//         let { name, price } = product;
//         console.log("Name: " + name);
//         console.log("Price: " + price);
...
// for (let product of products) {
//     console.log("------------------");
//     let { name, price, providers } = product;
//     console.log("Name: " + name);
//     console.log("Price: " + price);
...
// while (provider == '') {
//     alert("Input must not be empty");
//     provider = prompt("Enter provider");
// }
// for (let product of products) {
...
// 6.1
// console.log("Hi there, here's your learning tasks to FE engineering");
// for(let index in learningTasks){
//     let task = learningTasks[index];
...
//     store[positionUpdate-1].Name = newTitle
// }
// for (let i = 0; i<store.length; i++){
//     console.log(`${i+1}. ${store[i].Name} \n   Complete: ${store[i].Complete}\n`)
// }
// //6.2
// let command = prompt("Enter your command (New, Delete, Update, Complete)")
// if (command == "new"){
//     let newItem = prompt("Enter new task:")
//     store.push({Name: newItem,Complete: false})
// }
// for (let i = 0; i<store.length; i++){
//     console.log(`${i+1}. ${store[i].Name} \n   Complete: ${store[i].Complete}\n`)
// }
...
//     store[positionComplete-1].Complete = true
// }
// for (let i = 0; i<store.length; i++){
//     console.log(`${i+1}. ${store[i].Name} \n   Complete: ${store[i].Complete}\n`)
// }
...
// //6.5
// if (command == "delete"){
//     let positionDelete = prompt("Enter position:")
//     store.splice(positionDelete-1,1)
// }
// for (let i = 0; i<store.length; i++){
//     console.log(`${i+1}. ${store[i].Name} \n   Complete: ${store[i].Complete}\n`)
// }
